...
{%- block content %}
    ...
    {% if use_images_in_navigation_bar %}
        ...
        {% else %}
            <a class="navigation-button" id="first-button" href="{{ comic_base_dir }}/comic/{{ first_id }}/#comic-page"><img alt="First" src="{{ base_dir }}/your_content/images/navigation_icons/Icon_First>
            <a class="navigation-button" id="previous-button" href="{{ comic_base_dir }}/comic/{{ previous_id }}/#comic-page"><img alt="Previous" src="{{ base_dir }}/your_content/images/navigation_icons/I>
        {% endif %}
        ...
        {% else %}
            <a class="navigation-button" id="next-button" href="{{ comic_base_dir }}/comic/{{ next_id }}/#comic-page"><img alt="Next" src="{{ base_dir }}/your_content/images/navigation_icons/Icon_Next.png>
            <a class="navigation-button" id="last-button" href="{{ comic_base_dir }}/comic/{{ last_id }}/#comic-page"><img alt="Latest" src="{{ base_dir }}/your_content/images/navigation_icons/Icon_Latest>
        {% endif %}
    {% else %}
        {% if first_id == current_id %}
